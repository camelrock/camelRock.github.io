...
function findRecipes() {
    ...
    document.getElementById("tellIt").textContent = `there appear to be no recipes of humans eating ${term} so caution is to be advised. If you know '${term}' to be edible, consider sending your recipe to jmlunlocked@gmail.com for consideration`
